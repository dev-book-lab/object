...
이 장에서는 **8장의 의존성 관리 기법들을 원칙이라는 관점에서 재정리**합니다.
...
> 📂 **코드**: [`Movie.java`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step01/Movie.java) | [`DiscountPolicy.java`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step01/DiscountPolicy.java)
...
| 관점 | 의미 | 설명 |
|------|------|------|
| **확장에 열려 있다** | 동작의 관점 | 애플리케이션의 요구사항이 변경될 때 새로운 **'동작'**을 추가해서 기능을 **확장**할 수 있다 |
| **수정에 닫혀 있다** | 코드의 관점 | 기존의 **'코드'**를 수정하지 않고도 애플리케이션의 **동작**을 추가하거나 변경할 수 있다 |
...
> 📂 **코드**: [`Client.java`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step01/client/Client.java) | [`Factory.java`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step02/factory/Factory.java)
...
> 📂 **코드**: [`Movie.java (step01)`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step01/Movie.java) | [`ServiceLocator.java (step03)`](https://github.com/eternity-oop/object/blob/master/chapter09/src/main/java/org/eternity/movie/step03/locator/ServiceLocator.java)
...
// 객체 구조 (실행 시 실제 모습)
Movie avatar1 → AmountDiscountPolicy 인스턴스
Movie avatar2 → PercentDiscountPolicy 인스턴스
Movie avatar3 → OverlappedDiscountPolicy 인스턴스

→ 코드만 봐서는 실행 구조를 알 수 없음!
```
...
```java
// 체크리스트
□ if-else 또는 switch 문으로 타입 분기하는가?
□ 새로운 기능 추가 시 기존 클래스를 수정하는가?
□ 구체 클래스에 직접 의존하는가?
```
...
**[⬅️ 이전: Chapter 08](../chapter08/README.md) | [다음: Chapter 10 ➡️](../chapter10/README.md)**
